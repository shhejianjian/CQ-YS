...
@implementation CQGGSDSearchView
...
-(instancetype)initWithAlertViewHeight:(CGFloat)height
{
    self=[super init];
    if (self) {
        NSArray * nib = [[NSBundle mainBundle] loadNibNamed:@"CQGGSDSearchView" owner:self options:nil];
...
- (void)show:(BOOL)animated{
    if (animated)
    {
        ...
        __weak CQGGSDSearchView *weakSelf = self;
